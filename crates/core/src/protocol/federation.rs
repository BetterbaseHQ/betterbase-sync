...
mod tests {
    ...
    fn federation_invitation_params_cbor_roundtrip() {
        ...
        let decoded: FederationInvitationParams = serde_cbor::from_slice(&encoded).expect("decode");
    ...
    fn federation_invitation_result_cbor_roundtrip() {
        ...
        let decoded: FederationInvitationResult = serde_cbor::from_slice(&encoded).expect("decode");
